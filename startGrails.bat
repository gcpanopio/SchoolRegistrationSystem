...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\org.codehaus.groovy\groovy-all\jars\groovy-all-1.8.6.jar;%GRAILS_HOME%\dist\grails-bootstrap-2.0.3.jar
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.0.3
