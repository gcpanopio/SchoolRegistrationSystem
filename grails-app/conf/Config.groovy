...
grails.plugins.springsecurity.interceptUrlMap = [
	...
	'/course/**':	['ROLE_ADMIN'],	
	'/enrollment/**':	['ROLE_USER','ROLE_ADMIN'],
	'/student/**':	['ROLE_ADMIN'],
	'/teacher/**':	['ROLE_ADMIN'],
	'/room/**':	['ROLE_ADMIN'],
	'/studentclass/create':	['ROLE_ADMIN'],
	'/studentclass/edit':	['ROLE_ADMIN'],
	'/studentclass/_form':	['ROLE_ADMIN'],
	'/studentclass/list': ['ROLE_USER','ROLE_ADMIN'],
	'/studentclass/show': ['ROLE_USER','ROLE_ADMIN'],
	'/subject/**':	['ROLE_ADMIN'],
	'/timeslot/**':	['ROLE_ADMIN'],
	'/user/**':	['ROLE_ADMIN'],
	'/userrole/**':	['ROLE_ADMIN']
