	...
	<body>
		...
		<div id="show-room" class="content scaffold-show" role="main">
			...
			<ol class="property-list room">
				...
				<g:if test="${roomInstance?.roomNumber}">
				<li class="fieldcontain">
					<span id="roomNumber-label" class="property-label"><g:message code="room.roomNumber.label" default="Room Number" /></span>
					
						<span class="property-value" aria-labelledby="roomNumber-label"><g:fieldValue bean="${roomInstance}" field="roomNumber"/></span>
