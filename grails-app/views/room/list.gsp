			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="roomNumber" title="${message(code: 'room.roomNumber.label', default: 'Room Number')}" />
				...
				<g:each in="${roomInstanceList}" status="i" var="roomInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${roomInstance.id}">${fieldValue(bean: roomInstance, field: "roomNumber")}</g:link></td>
